...
_Built by `scripts/phase2-merge.py` over **9 pass(es)**: pass-00, pass-01, pass-02, pass-03, pass-04, pass-05, pass-06, pass-07, pass-08. `times` = how many independent passes proposed this candidate (confidence); `opus` = an Opus run also proposed it. Re-run after every pass._

**828 unique candidates** (deduped on mod + item + pillar + motif).

| times | opus | mod | from → | via (method) | pillar | motif | consensus |
|--:|:--:|---|---|---|---|---|---|
| 9 | ✓ | `farm_and_charm` | farm_and_charm:barley / oat (grains) | create:milling | create | M-12 | ACCEPT |
| 9 | ✓ | `underground_village` | Stoneholm villager trades (loot=yes, villagers | numismatics villager-trade seating | economy | M-21 | REJECT |
| 9 | ✓ | `undergroundworlds` | undergroundworlds:spider_fang (Black Recluse d | occultism:spirit_fire | magic | M-11 | ACCEPT |
| 8 |  | `create_new_age` | create_new_age:thorium_ore (scarce biome-gated | create:crushing → numismatics mint | economy | M-08 | ACCEPT |
| 8 | ✓ | `deeperdarker` | deeperdarker:soul_dust / soul_crystal (Othersi | occultism:spirit_fire | magic | M-11 | ACCEPT |
| 8 |  | `dynamictreesplus` | dynamictreesplus:saguaro_fruit | create:milling | create | M-12 | ACCEPT |
| 8 |  | `endrem` | endrem:undead_eye | occultism:ritual (wither skeleton  | magic | M-11 | ACCEPT |
| 8 |  | `enhancedcelestials` | enhancedcelestials:meteor | create:crushing | create | M-04 | ACCEPT |
| 8 | ✓ | `expandeddelight` | expandeddelight:salt_ore / deepslate_salt_ore | create:crushing | create | M-03 | ACCEPT |
| 8 |  | `expandeddelight` | expandeddelight:cinnamon (c:dusts/cinnamon) | create:milling | create | M-12 | ACCEPT |
| 8 |  | `expandeddelight` | expandeddelight:cheese_wheel / goat_cheese_whe | numismatics sell | economy | M-09 | ACCEPT |
| 8 |  | `tfmg` | tfmg:diesel / tfmg:gasoline / tfmg:lpg (TFMG d | TFMG combustion engine → Aeronauti | aeronautics | M-13 | ACCEPT |
| 7 | ✓ | `cold_sweat` | cold_sweat:hearth (the multiblock climate-cont | create:mechanical_crafting (gate i | create | M-05 | ACCEPT |
| 7 |  | `createmetalwork` | createmetalwork processed metals (molten_<scar | numismatics coin mint — refined mo | economy | M-08 | ACCEPT |
| 7 |  | `drones` | drones:pocket_drone (assembled) | numismatics sell | economy | M-09 | REJECT |
| 7 |  | `dynamictreesplus` | dynamictreesplus:saguaro_fruit | numismatics sell | economy | M-09 | REJECT |
| 7 |  | `immersive_armors` | immersive_armors:heavy_chestplate set (Heavy / | create:pressing (plates) + create: | create | M-05 | ACCEPT |
| 7 |  | `sereneseasons` | out-of-season produce (scarce) | numismatics sell | economy | M-09 | REJECT |
| 7 |  | `tide` | tide raw fish output (c:foods/raw_fish, bulk s | farmersdelight:cutting → create:mi | create | M-12 | ACCEPT |
| 7 | ✓ | `undergroundworlds` | undergroundworlds:temple_bricks / pyramid_bric | create:crushing | create | M-04 | ACCEPT |
| 6 | ✓ | `bakery` | wheat (crop input) | create:milling — mill wheat to flo | create | M-12 | ACCEPT |
| 6 |  | `bosses_of_mass_destruction` | bosses_of_mass_destruction:ancient_anima | ars_nouveau:imbuement (highest-tie | magic | M-10 | ACCEPT |
| 6 |  | `brazil_legends` | brazil_legends:capelobo_claw | occultism:spirit_fire | magic | M-11 | ACCEPT |
| 6 |  | `brazil_legends` | brazil_legends:amber_shard | numismatics sell | economy | M-09 | REJECT |
| 6 |  | `cookingforblockheads` | cookingforblockheads:oven / cookingforblockhea | create:mechanical_crafting (gate e | create | M-05 | ACCEPT |
| 6 |  | `create_ironworks` | create_ironworks:tin_ingot / c:ingots/tin (sca | create:crushing → numismatics mint | economy | M-08 | ACCEPT |
| 6 |  | `create_new_age` | create_new_age:energising (method: the Energis | create_new_age:energising of a mag | magic | M-17 | ACCEPT |
| 6 |  | `createimmersivetacz` | createimmersivetacz:twelve_gauge_shell / creat | numismatics sell/trade | economy | M-09 | ACCEPT |
| 6 |  | `drones` | drones:ion_thruster | create:sequenced_assembly | create | M-06 | ACCEPT |
| 6 |  | `drones` | drones:iron_rotor | create:mechanical_crafting (brass  | create | M-05 | ACCEPT |
| 6 |  | `dynamictreesplus` | dynamictreesplus:brown_mushroom_cap / red_mush | farmersdelight:cutting | create | M-12 | ACCEPT |
| 6 |  | `enhancedcelestials` | enhancedcelestials:space_moss_block | ars_nouveau:imbuement (source-gem  | magic | M-10 | REJECT |
| 6 | ✓ | `enhancedcelestials` | Blood/Harvest/Blue Moon event state (no item) | any recipe-type method | magic | M-22 | ACCEPT |
| 6 |  | `farm_and_charm` | farm_and_charm:butter / eggs / meat surplus (a | numismatics sell | economy | M-09 | ACCEPT |
| 6 |  | `friendsandfoes` | friendsandfoes:crab_claw | ars_nouveau:imbuement OR occultism | magic | M-02 | ACCEPT |
| 6 |  | `immersive_armors` | immersive_armors:divine_chestplate set | ars_nouveau:enchanting_apparatus | magic | M-10 | ACCEPT |
| 6 |  | `mushroomquest` | mushroomquest rare / mythical mushroom caps (a | numismatics sell | economy | M-09 | ACCEPT |
| 6 |  | `mushroomquest` | mushroomquest deadly / mythical mushroom caps | occultism:spirit_fire or ars_nouve | magic | M-11 | ACCEPT |
| 6 |  | `rottencreatures` | rottencreatures:frozen_rotten_flesh (Frostbitt | occultism:spirit_fire | magic | M-11 | ACCEPT |
| 6 |  | `tfmg` | tfmg:steel_ingot (iron → Industrial Blast Furn | numismatics mint | economy | M-08 | ACCEPT |
| 6 |  | `vc_gliders` | vc_gliders:paraglider_diamond / paraglider_net | create:mechanical_crafting | create | M-05 | ACCEPT |
| 5 | ✓ | `aileron` | aileron Elytra enchantments | ars_nouveau:enchanting_apparatus / | magic | M-10 | REJECT |
| 5 |  | `brazil_legends` | brazil_legends:amber_shard | ars_nouveau:imbuement | magic | M-10 | ACCEPT |
| 5 |  | `copperagebackport` | copper deco blocks (copper_chest, copper_bars, | create:crushing | create | M-04 | ACCEPT |
| 5 |  | `create_enchantment_industry` | create_enchantment_industry:experience_bucket  | ars_nouveau:imbuement | magic | M-10 | ACCEPT |
| 5 |  | `create_new_age` | create_new_age:corium (reactor waste) | occultism:spirit_fire | magic | M-11 | REJECT |
| 5 | ✓ | `createaddition` | createaddition:charging method + createadditio | createaddition:charging → irons_sp | magic | M-17 | ACCEPT |
| 5 |  | `endrem` | endrem:corrupted_eye | create:sequenced_assembly (derpack | create | M-06 | REJECT |
| 5 | ✓ | `farm_and_charm` | farm_and_charm husbandry surplus (meat / eggs  | minecolonies food supply (restaura | economy | M-09 | ACCEPT |
| 5 |  | `mowziesmobs` | mowziesmobs:ice_crystal (Frostmaw drop) | create:sequenced_assembly (gate in | create | M-15 | ACCEPT |
| 5 |  | `mowziesmobs` | mowziesmobs (boss kills) | bountiful bounty → numismatics | economy | M-14 | REJECT |
| 5 |  | `oceansdelight` | oceansdelight:elder_guardian_roll / fugu_slice | numismatics sell | economy | M-09 | ACCEPT |
| 5 |  | `rottencreatures` | rottencreatures:magma_rotten_flesh (magma-vari | occultism:spirit_fire | magic | M-11 | ACCEPT |
| 5 |  | `sereneseasons` | season_sensor redstone output | create:deploying / contraption log | create | M-16 | ACCEPT |
| 5 |  | `smokeleafindustries` | refined extracts / gummies (finished consumabl | numismatics sell / dealer-trade br | economy | M-09 | ACCEPT |
| 5 |  | `smokeleafindustries` | raw hemp / buds | create:milling | create | M-12 | REJECT |
| 5 |  | `solonion` | solonion:golden_lunchbox (top-tier food contai | create:mechanical_crafting | create | M-05 | ACCEPT |
| 5 |  | `spawn` | spawn seafood (general) | createfisheryindustry:bait_trap —  | create | M-12 | REJECT |
| 5 |  | `tide` | tide rare/biome-locked fish (e.g. tide:abyss_a | numismatics sell | economy | M-09 | ACCEPT |
| 4 | ✓ | `alexsmobs` | alexsmobs:ambergris (rare whale-adjacent drop  | ars_nouveau:imbuement | magic | M-10 | ACCEPT |
| 4 |  | `alexsmobs` | alexsmobs:bear_dust (rare, combat drop) | occultism:ritual | magic | M-02 | ACCEPT |
| 4 | ✓ | `alexsmobs` | alexsmobs:ambergris | numismatics vendor/price | economy | M-09 | ACCEPT |
| 4 |  | `alexsmobs` | alexsmobs:ambergris (rare ocean-mob drop — spe | occultism:spirit_fire → spirit-rea | magic | M-11 | ACCEPT |
| 4 | ✓ | `bakery` | bakery finished goods (cakes, tarts, jams, bre | numismatics sell | economy | M-09 | ACCEPT |
| 4 |  | `bakery` | bakery:strawberry_cake / chocolate_gateau / li | numismatics sell — high-effort mul | economy | M-09 | ACCEPT |
| 4 |  | `bosses_of_mass_destruction` | bosses_of_mass_destruction:void_thorns (from V | occultism:ritual (high-tier summon | magic | M-11 | ACCEPT |
| 4 | ✓ | `bosses_of_mass_destruction` | boss reagents (any) | numismatics sell or bountiful boun | economy | M-14 | REJECT |
| 4 |  | `bosses_of_mass_destruction` | bosses_of_mass_destruction:obsidian_heart (Nig | create:sequenced_assembly (as requ | create | M-15 | ACCEPT |
| 4 |  | `copperagebackport` | Copper Golem (minecraft:copper_golem_statue, l | thematic adjacency to Create logis | aeronautics |  | REJECT |
...
| 4 |  | `createaddition` | createaddition:seed_oil / bioethanol (crop-der | createaddition:liquid_burning → nu | economy | M-09 | REJECT |
| 4 |  | `createnuclear` | createnuclear:uranium (ore → dust → fuel, c:or | create:crushing → numismatics mint | economy | M-08 | ACCEPT |
| 4 |  | `deeperdarker` | deeperdarker:heart_of_the_deep (boss drop — Wa | ars_nouveau:imbuement | magic | M-10 | ACCEPT |
...
| 4 |  | `farm_and_charm` | farm_and_charm:barley (grain) | vinery:apple_mashing or extradelig | economy | M-12 | REJECT |
...
| 4 |  | `mowziesmobs` | mowziesmobs:ice_crystal (Frostmaw drop, endgam | create:sequenced_assembly | create | M-06 | ACCEPT |
| 4 |  | `rottencreatures` | rottencreatures:corrupted_wart | ars_nouveau:imbuement | magic | M-10 | ACCEPT |
| 4 |  | `sereneseasons` | sereneseasons:season_sensor (redstone output k | Create redstone logic (gearshifts, | create | M-16 | ACCEPT |
| 4 |  | `smokeleafindustries` | smokeleafindustries:generator FE output | createaddition:charging (FE↔kineti | create | M-17 | ACCEPT |
| 4 |  | `solonion` | solonion:lunchbox | create:pressing / milling | create | M-05 | REJECT |
| 4 |  | `spawn` | spawn:clam (various colour variants, obtained  | numismatics sell | economy | M-09 | ACCEPT |
| 4 |  | `t_and_t` | t_and_t villager variants (16 biome-specific v | numismatics — village settlements  | economy | M-21 | REJECT |
...
| 4 |  | `trailandtales_delight` | trailandtales_delight:lantern_fruit (tagged it | create:milling | create | M-12 | ACCEPT |
| 4 |  | `travelersbackpack` | travelersbackpack:netherite / travelersbackpac | create:sequenced_assembly | create | M-06 | ACCEPT |
| 4 |  | `vc_gliders` | vc_gliders:paraglider_iron / _gold / _diamond  | create:pressing (metal sheets) + c | create | M-05 | ACCEPT |
...
| 3 |  | `bakery` | bakery baked goods (surplus production) | ars_nouveau:imbuement (Vitalic sou | magic | M-10 | REJECT |
...
| 3 |  | `bountiful` | bountiful:bounty (payout reward slot) | numismatics coin as the default bo | economy | M-14 | ACCEPT |
| 3 |  | `cold_sweat` | cold_sweat:filled_waterskin (hot/cold) | create:filling (already exists as  | create | M-12 | REJECT |
...
| 3 |  | `create_ironworks` | create_ironworks:steel_ingot / steel plate (it | M-23 structural alloy → aeronautic | aeronautics | M-23 | ACCEPT |
...
| 3 |  | `createoreexcavation` | createoreexcavation:diamond_drill / netherite_ | create:sequenced_assembly | create | M-06 | REJECT |
...
| 3 |  | `friendsandfoes` | friendsandfoes copper deco (copper buttons / l | create:crushing | create | M-04 | REJECT |
| 3 |  | `modulargolems` | modulargolems golem upgrade slots (add_1_slot  | ars_nouveau:imbuement or occultism | magic | M-10 | REJECT |
...
| 3 |  | `mushroomquest` | mushroomquest edible/effect mushrooms (common  | farmersdelight:cooking + extradeli | create | M-12 | ACCEPT |
| 3 | ✓ | `oceansdelight` | oceansdelight raw seafood intermediates (cut_t | create:cutting / farmersdelight:cu | create | M-12 | REJECT |
| 3 |  | `oceansdelight` | oceansdelight:cut_tentacles / guardian drops | farmersdelight:cutting → create:mi | create | M-12 | REJECT |
| 3 |  | `rottencreatures` | rottencreatures mob heads (decorative blocks) | create:crushing | create | M-04 | REJECT |
| 3 |  | `rottencreatures` | rottencreatures:frozen_rotten_flesh | create:haunting | create | M-19 | REJECT |
...
| 3 |  | `sky_whale_ship` | sky_whale_ship loot chests | numismatics coin drop | economy | M-09 | REJECT |
...
| 3 | ✓ | `solonion` | golden_lunchbox (the tier-3 best food containe | create:mechanical_crafting | create | M-05 | ACCEPT |
| 3 | ✓ | `tide` | tide rare/biome-locked fish (abyss_angler, voi | numismatics sell | economy | M-09 | ACCEPT |
...
| 3 |  | `undergroundworlds` | undergroundworlds:spider_fang | ars_nouveau:imbuement | magic | M-02 | REJECT |
...
| 2 |  | `alexsmobs` | alexsmobs:ambergris (mid drop, whale-type mob) | occultism:spirit_fire | magic | M-02 | ACCEPT |
| 2 |  | `alexsmobs` | alexsmobs:ender_residue (mid/endgame drop, end | occultism:spirit_fire | magic | M-02 | ACCEPT |
| 2 |  | `alexsmobs` | alexsmobs:banana (tropical food, renewable fro | farmersdelight:cooking or extradel | economy | M-12 | ACCEPT |
| 2 |  | `alexsmobs` | alexsmobs:ender_residue (void worm drop, endga | ars_nouveau:imbuement → arcane rea | magic | M-10 | ACCEPT |
...
| 2 | ✓ | `betterdungeons` | dungeon chest loot | loot-table seeding of magic reagen | magic | M-02 | REJECT |
...
| 2 | ✓ | `bountiful` | bounty reward payout | bountiful board → numismatics (set | economy | M-14 | ACCEPT |
...
| 2 |  | `brazil_legends` | brazil_legends:big_tongue (Cuca/folklore drop) | occultism:ritual | magic | M-11 | REJECT |
...
| 2 |  | `create_enchantment_industry` | create_enchantment_industry:experience_bucket  | occultism:ritual | magic | M-11 | REJECT |
| 2 |  | `create_enchantment_industry` | create_enchantment_industry liquid XP (experie | irons_spellbooks:alchemist_cauldro | magic | M-10 | ACCEPT |
...
| 2 |  | `create_ironworks` | create_ironworks:steel_ingot (near-Netherite,  | occultism:spirit_fire or ars_nouve | magic | M-10 | REJECT |
| 2 |  | `create_ironworks` | create_ironworks:bronze_ingot / tin_ingot | ars_nouveau:imbuement or occultism | magic | M-10 | REJECT |
| 2 |  | `create_ironworks` | create_ironworks:steel_plate / steel_ingot (fa | aeronautics airframe/hull recipe ( | aeronautics | M-23 | ACCEPT |
| 2 |  | `create_new_age` | create_new_age:energising (method) | create_new_age:energising | aeronautics | M-24 | ACCEPT |
| 2 |  | `createaddition` | farmed seeds / crops → createaddition:seed_oil | M-12 processing-chain pull — agric | survival | M-12 | ACCEPT |
...
| 2 |  | `createaddition` | `createaddition:rolling` producing `c:rods/all | Aeronautics structural hull/frame  | aeronautics | M-24 | ACCEPT |
...
| 2 |  | `createnuclear` | createnuclear:lead_ingot / c:ingots/lead (bypr | create:crushing → numismatics mint | economy | M-08 | REJECT |
| 2 |  | `createnuclear` | createnuclear:steel_ingot (c:ingots/steel, sca | numismatics mint | economy | M-08 | ACCEPT |
...
| 2 | ✓ | `createoreexcavation` | vein-table ore output (scarce/regional coin-gr | createoreexcavation:vein → create: | economy | M-08 | ACCEPT |
...
| 2 |  | `deeperdarker` | deeperdarker:soul_dust / Otherside mob drops | numismatics sell | economy | M-09 | REJECT |
...
| 2 |  | `dndesires` | dndesires milkshake foods | farm_and_charm:stove / extradeligh | survival | M-12 | REJECT |
| 2 |  | `dndesires` | dndesires:rubber (hydraulic_compacting output) | aeronautics construction recipe | aeronautics | M-23 | ACCEPT |
...
| 2 |  | `endrem` | endrem:magical_eye (arcane-named variant) | ars_nouveau:enchanting_apparatus | magic | M-10 | REJECT |
...
| 2 |  | `friendsandfoes` | friendsandfoes:crab_claw | ars_nouveau:imbuement | magic | M-10 | REJECT |
...
| 2 |  | `modulargolems` | modulargolems golem assembly (boss/mob-drop me | modulargolems:golem_assemble | survival | M-02 | ACCEPT |
...
| 2 |  | `samurai_dynasty` | samurai_dynasty:akaname_tongue / Yokai mob dro | occultism:spirit_fire or ars_nouve | magic | M-11 | ACCEPT |
...
| 2 |  | `tfmg` | tfmg:steel (blast-furnace output) | aeronautics hull/airframe construc | aeronautics | M-23 | ACCEPT |
| 2 |  | `tfmg` | tfmg combustion engine / flywheel assembly | aeronautics propulsion/drivetrain  | aeronautics | M-24 | ACCEPT |
| 2 |  | `tfmg` | tfmg:steel / tfmg:aluminum ingot (processed sc | numismatics sell / M-08 coin from  | economy | M-08 | ACCEPT |
| 2 | ✓ | `tide` | tide fish byproducts / trophies | create:crushing / milling → fishme | create | M-12 | ACCEPT |
| 2 |  | `tide` | tide:abyss_angler / void-fish | occultism:spirit_fire or ars_nouve | magic | M-02 | REJECT |
...
| 2 |  | `trailandtales_delight` | trailandtales_delight:ancient_coffee / cherry_ | numismatics sell | economy | M-09 | ACCEPT |
| 2 |  | `trailandtales_delight` | trailandtales_delight:cherry_cheese_pie / anci | numismatics sell / price | economy | M-09 | ACCEPT |
...
| 1 |  | `aileron` | (Elytra enchantments injected via loot tables) | ars_nouveau:enchanting_apparatus — | magic | M-10 | ACCEPT |
| 1 |  | `aileron` | Elytra (vanilla item) | ars_nouveau:enchanting_apparatus | magic | M-10 | REJECT |
...
| 1 |  | `alexsmobs` | alexsmobs:bear_dust (common bear kill drop) | occultism:spirit_fire | magic | M-11 | ACCEPT |
...
| 1 |  | `betterdungeons` | dungeon chest loot tables | loot-table seeding (datapack edit, | economy | M-14 | ACCEPT |
| 1 |  | `betterdungeons` | betterdungeons dungeon chest loot (Catacombs / | numismatics loot-table seed | economy | M-09 | ACCEPT |
...
| 1 |  | `bountiful` | bountiful bounty payout | numismatics with M-21 villager-tra | economy | M-21 | REJECT |
...
| 1 |  | `brazil_legends` | brazil_legends:big_tongue | occultism:spirit_fire | magic | M-02 | REJECT |
...
| 1 |  | `create_ironworks` | create_ironworks:bronze_plate / bronze_ingot | aeronautics drivetrain/control (M- | aeronautics | M-24 | ACCEPT |
...
| 1 |  | `create_new_age` | create_new_age advanced_motor / reinforced_mot | aeronautics drivetrain | aeronautics | M-24 | ACCEPT |
| 1 | ✓ | `create_new_age` | FE / energising | createaddition:charging or create_ | magic | M-17 | ACCEPT |
...
| 1 |  | `create_new_age` | create_new_age:advanced_motor / generator_coil | create_new_age:energising + create | aeronautics | M-24 | ACCEPT |
...
| 1 |  | `createaddition` | FE-chargeable Iron's Spellbooks gear / magic-e | createaddition:charging (tesla coi | magic | M-17 | ACCEPT |
...
| 1 |  | `createmetalwork` | createmetalwork molten_steel (a structural all | aeronautics airframe/hull ingredie | aeronautics | M-23 | ACCEPT |
| 1 |  | `createmetalwork` | createmetalwork:molten_steel (structural alloy | M-23 airframe/hull structural allo | aeronautics | M-23 | ACCEPT |
| 1 |  | `createmetalwork` | createmetalwork:crushed_raw_materials/* (the b | occultism:crushing or ars_nouveau: | magic | M-10 | ACCEPT |
| 1 |  | `createmetalwork` | createmetalwork:molten_steel_bucket | aeronautics structural recipe (ste | aeronautics | M-23 | ACCEPT |
...
| 1 |  | `dndesires` | dndesires:rubber | numismatics sell | economy | M-09 | REJECT |
...
| 1 |  | `enhancedcelestials` | enhancedcelestials:space_moss_block | create:milling | create | M-12 | REJECT |
...
| 1 |  | `formationsnether` | formationsnether structure loot tables | loot-table injection — add a numis | economy | M-09 | REJECT |
...
| 1 |  | `immersive_armors` | immersive_armors finished sets | numismatics sell | economy | M-09 | REJECT |
...
| 1 |  | `immersive_armors` | immersive_armors:steampunk set (visual + tone) | create:mechanical_crafting (assemb | create | M-05 | ACCEPT |
...
| 1 |  | `mowziesmobs` | boss drop bounty | numismatics bounty board | economy | M-14 | REJECT |
...
| 1 | ✓ | `samurai_dynasty` | jade/ruby/onyx/aquamarine ores | create:crushing | create | M-03 | ACCEPT |
...
| 1 |  | `samurai_dynasty` | samurai_dynasty:steel (c:ingots/steel) | create:crushing (for any excess st | create | M-03 | ACCEPT |
...
| 1 | ✓ | `spawn` | clam/crab/anglerfish seafood drops | create:milling / farmersdelight:cu | create | M-12 | ACCEPT |
...
| 1 |  | `spawn` | spawn:clam (color variants) + crab drops | create:milling → seafood meal / sh | create | M-12 | ACCEPT |
...
| 1 |  | `t_and_t` | t_and_t conquered fort loot chests | bountiful Decree — a Decree target | economy | M-14 | ACCEPT |
...
| 1 |  | `tfmg` | tfmg:steel_ingot (processed scarcity, multi-st | crafting / aeronautics structural  | aeronautics | M-23 | ACCEPT |
| 1 |  | `tfmg` | tfmg:combustion_engine (mechanical component) | Aeronautics drivetrain/propulsion  | aeronautics | M-24 | ACCEPT |
...
| 1 |  | `travelersbackpack` | travelersbackpack upgrade modules (tank_upgrad | travelersbackpack:backpack_upgrade | create | M-06 | ACCEPT |
...
| 1 |  | `undergroundworlds` | undergroundworlds temple/pyramid bricks (theme | create:crushing → crushed stone +  | create | M-04 | REJECT |
...
| 1 |  | `valarian_conquest` | faction armor/weapon (armorsmith station) | create:mechanical_crafting or M-05 | create | M-05 | REJECT |
...
| 1 |  | `vc_gliders` | vc_gliders:paraglider_iron (base tier glider) | create:pressing (reinforced paper  | create | M-12 | ACCEPT |
