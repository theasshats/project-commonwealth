...
- from: mowziesmobs:ice_crystal (Frostmaw drop) | via: create:sequenced_assembly | to: create | motif: M-15 | power: endgame | tone: ok | verdict: ACCEPT | hook: the Ice Crystal is a rare non-renewable boss drop from a set-piece fight; requiring it as a component in a high-tier Create sequenced_assembly (e.g. a cryogenic heat exchanger or ice-cooled precision mechanism) gates advanced Create tech behind combat progression. Red-team: tonally coherent — Frostmaw's essence channeled into an industrial cooling component is a player-understandable pairing. Survives. Adds Create anchor.
- from: mowziesmobs:earthrend_gauntlet / wrought-metal artifacts (Wroughtnaut drops) | via: create:mechanical_crafting | to: create | motif: M-06 | power: endgame | tone: ok | verdict: ACCEPT | hook: the Wroughtnaut's ancient wrought-metal artifacts feed a sequenced_assembly chain as structural alloy material — the hardest metals in the game earned by a legendary fight become the raw stock for a high-tier Create exo-frame or multi-block component. Red-team: the Earthrend Gauntlet is a unique artifact item (unbreakable melee weapon), which complicates using it as a crafting input; the wrought helm is a better target (or a custom drop from the Wroughtnaut specifically for crafting). Survives with the caveat: use a dedicated crafting-drop, not the unique wearable weapon, for the recipe input.
- from: mowziesmobs:ice_crystal | via: occultism:spirit_fire | to: magic | motif: M-11 | power: endgame | tone: ok | verdict: ACCEPT | hook: transmuting the Frostmaw's ice crystal in occultism spirit fire yields a cryo-essence for Occultism rituals or Ars Nouveau infusion — a boss-drop-to-magic-reagent routing that deepens the magic web with a combat requirement. Red-team: ice-elemental boss → cryo magic reagent is tight thematically. Survives. Adds magic anchor.
- from: mowziesmobs:sol_visage (Barako solar artifact) | via: ars_nouveau:imbuement | to: magic | motif: M-10 | power: endgame | tone: ok | verdict: ACCEPT | hook: the Sol Visage (Barako's solar-power mask) imbibed with source gems produces a solar attunement catalyst for high-tier Ars Nouveau spells — a boss drop feeding the arcane infusion system. Red-team: a sun-worshipper's artifact becoming a solar-fire spell catalyst is tonally exact. Survives. Adds magic anchor (paired with M-11 for the ice line).
- from: mowziesmobs boss drops (any) | via: loot-table bounty | to: economy | motif: M-34 | power: endgame | tone: ok | verdict: ACCEPT | hook: combat specialists farm Mowzie's boss kills and trade the unique drops (ice crystal, wrought artifacts, sol visage) to non-combat players who need them for Create tech or magic — the supplier side of the boss dual-role, completing the loop. Red-team: "someone farms bosses and sells drops" is the expected behavior; M-34 formalizes it as a deliberate design weave rather than an emergent side-effect. Survives.
- from: mowziesmobs:blowgun + dart | via: createaddition:charging | to: create | motif: M-17 | power: mid | tone: clash | verdict: REJECT | reason: FE-charging a blowgun is a tone clash — a dart blowpipe is tribal/organic in feel; making it require electric charging undermines the Mowzie's aesthetic. No clean M-17 fit. Rejected on theme.
- from: mowziesmobs:captured_grottol (rare ore-eating mob item) | via: create:crushing | to: create | motif: M-32 | power: mid | tone: ok | verdict: REJECT | reason: the captured Grottol is a mob-bottle item (like a bucket of mob), not a crushable material. Routing it through create:crushing to extract ore byproducts is mechanically implausible and thematically uncomfortable ("I crushed the rare creature for ore"). Rejected.
- REWORK: the dossier's "economy via Numismatics bounty" candidate is marked WEAK and tagged M-08 — but it's more precisely M-34 (combat-route supply, the supplier side of boss economics), not M-08 (player-minted currency). M-08 refers to the minting process itself; M-34 is what is being claimed here. The motif label should be corrected.
