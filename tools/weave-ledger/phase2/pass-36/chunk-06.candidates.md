...
Power-read: 20 blocks (mob heads + novelty), 30 items. Undead variants: Frostbitten (cold biomes/powder snow), Swampy (poison+blindness), Dead Beard (pirate captain, beach), Immortal (thunderstorm lich), Undead Miner (4 tier ranks). loot=yes. Distinctive drops: frozen_rotten_flesh, magma_rotten_flesh, corrupted_wart. Decorative mob heads (20 block types). The Immortal spawns during thunderstorms (lunar/event-gated adjacent); the Frostbitten ties to cold biomes and powder snow. Drop themes: elemental (frost, magma), corruption (wart).

- from: rottencreatures:frozen_rotten_flesh (Frostbitten drop, cold biomes) | via: occultism:spirit_fire — frozen flesh dissolving in spirit fire transmutes into an ice-essence or void crystal shard feeding the occultism reagent web | to: magic | motif: M-11 | power: mid | tone: ok — undead biome-themed drops transmuting through spirit fire is exactly M-11's scope; the elemental theme (frost/undead) is Occultism-adjacent | verdict: ACCEPT | hook: frozen rotten flesh from a Frostbitten zombie, dissolved in spirit fire, yields a cryo-essence used in Occultism rituals — cold-biome combat feeds the occultist's workshop

- from: rottencreatures:magma_rotten_flesh (Undead Miner / magma-adjacent drop) | via: occultism:spirit_fire — magma flesh into a heat-essence or related occultism reagent | to: magic | motif: M-11 | power: mid | tone: ok — same pattern; elemental pairing with frozen_rotten_flesh | verdict: REJECT | reason: two separate spirit_fire routes for thematically similar "elemental rotten flesh" drops fragment the system unnecessarily. Better to define a single "rottencreatures elemental flesh → occultism essence" spirit_fire recipe that covers both frozen and magma variants into one output, handled in Phase 3. The ACCEPT on frozen_rotten_flesh covers both; listing magma separately creates duplicate candidates.

- from: rottencreatures:corrupted_wart (Swampy drop, poison-mob variant of Nether wart) | via: ars_nouveau:imbuement — corrupted wart imbued into a source-gem produces a corrupted magic reagent feeding a Ars poison glyph or a higher-tier infusion | to: magic | motif: M-10 | power: mid | tone: ok — corrupted wart is a direct magic-ingredient shape (wart is already magic-adjacent in vanilla); imbuement makes it an Ars feedstock | verdict: ACCEPT | hook: a Swampy zombie's corrupted wart, imbued in the enchanting apparatus with source gems, yields a reagent for your most potent poison glyphs — the swamp's undead feeds Ars Nouveau

- from: rottencreatures:frozen_rotten_flesh | via: create:haunting — soul-fire haunting transforms the flesh into a soul-touched material; freeze + fire → something strange | to: create | motif: M-19 | power: mid | tone: clash — haunting is thematically "soul fire touches something ordinary," which resonates weakly with "frozen undead flesh." The connection is a stretch; frozen flesh → soul output has no clear player logic. | verdict: REJECT | reason: tone clash — the soul-fire haunting method has no thematic pull on frozen rotten flesh specifically; M-11 (spirit_fire → occultism essence) is the cleaner soul-themed route and is already ACCEPTed. Don't split the same drop across two "soul"-ish methods.

- from: rottencreatures:immortal (thunderstorm lich, spawns only during storms) | via: event-gating — the Immortal's unique drops are only obtainable during a thunderstorm, making its reagents a time-gated (event-gated) input analogous to a lunar reagent | to: magic | motif: M-22 | power: mid | tone: ok — a lich that only appears during storms producing a storm-charged reagent mirrors the lunar reagent concept; the celestial/storm event restriction creates reliable scarcity | verdict: ACCEPT | hook: the Immortal's head and any reagent it drops carry storm-charge — only harvestable when lightning walks the world; the occultist waits for the storm, not the moon

- from: rottencreatures:dead_beard (pirate captain, rare beach spawn) | via: loot-seed — the Dead Beard's treasure_chest (already in the mod's blocks) is seeded with Numismatics coin, making the pirate kill a minor economy reward | to: economy | motif: M-34 | power: mid | tone: ok — a pirate captain dropping treasure is the most intuitive possible loot-economy link; M-34 (combat-route supply) + the buried treasure framing fits perfectly | verdict: ACCEPT | hook: the Dead Beard's treasure chest holds minted coin — a combat specialist hunting beach pirates earns currency to trade for what they can't make

- from: rottencreatures:undead_miner (4 tier ranks, underground biomes) | via: loot-seed — higher-ranked Undead Miners drop ore-adjacent loot (crushed ore, Create experience_nuggets, or a rare Create component) at increasing rates per tier | to: create | motif: M-03 | power: mid | tone: ok — undead miners are thematically underground ore-related; their drops connecting to the ore-processing chain (M-03 ore-doubling) is coherent | verdict: ACCEPT | hook: a high-rank Undead Miner drops partially crushed ore — a wandering miner who got too deep into the ore seam, his pockets still full of what he dug

REWORK: The dossier's magic candidates (M-02/M-11) are directionally correct and this pass confirms them with specific motif assignments. This pass adds M-22 (Immortal storm-event gating → magic reagent) and M-34 (Dead Beard pirate kill → economy coin) as new candidates not listed in the dossier. The Create-haunting (M-19) candidate for frozen flesh is REJECTed on tone.
