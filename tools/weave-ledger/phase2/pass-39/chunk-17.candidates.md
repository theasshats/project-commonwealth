...
- from: Cook/Chef village structures (exploration content) | via: loot-seed | to: survival | motif: M-34 | power: mid | tone: ok | verdict: ACCEPT | hook: the village cook structures are worth clearing — a combat specialist raids the cook's stores (stocked larder chests, unique recipe books) and sells the haul to non-combat players. The structure becomes a combat-supply node, reinforcing the survival/danger face rather than an NPC faucet.
