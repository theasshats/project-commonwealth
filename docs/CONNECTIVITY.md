...
- item nodes: **17972**  (+2856 `c:` tags)
- connected components: **1920**
- giant component ("the web"): **14579** items — 81% of items
- items OUTSIDE the web: **3393** across 1919 clusters

## Depth — hops from the Create spine

reachable from `create:*`: **14702** items (avg **1.8** hops); unreachable: **3270**
  0:699  1:7332  2:3445  3:1861  4:931  5:273  6:62  7:22  8:8 …

## Load-bearing mods (cut vertices — removing one splits the mod web)

  `create`(100), `extradelight`(49), `touhou_little_maid`(39), `justenoughbreeding`(30), `farm_and_charm`(6), `occultengineering`(5), `companions`(2)
