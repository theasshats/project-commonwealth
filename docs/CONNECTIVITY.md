...
- item nodes: **17089**  (+2859 `c:` tags)
- connected components: **1958**
- giant component ("the web"): **13381** items — 78% of items
- items OUTSIDE the web: **3708** across 1957 clusters

## Depth — hops from the Create spine

reachable from `create:*`: **13504** items (avg **1.8** hops); unreachable: **3585**
  0:698  1:6590  2:3336  3:1782  4:712  5:209  6:70  7:22  8:10 …

## Load-bearing mods (cut vertices — removing one splits the mod web)

  `create`(98), `extradelight`(48), `touhou_little_maid`(39), `farm_and_charm`(6)
