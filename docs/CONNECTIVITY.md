...
- connected components: **1951**
- giant component ("the web"): **13479** items — 78% of items
- items OUTSIDE the web: **3610** across 1950 clusters

## Depth — hops from the Create spine

reachable from `create:*`: **13602** items (avg **1.8** hops); unreachable: **3487**
  0:698  1:6597  2:3406  3:1803  4:712  5:209  6:70  7:22  8:10 …
