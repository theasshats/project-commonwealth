...
- item nodes: **17048**  (+2815 `c:` tags)
- connected components: **1767**
- giant component ("the web"): **13913** items — 81% of items
- items OUTSIDE the web: **3135** across 1766 clusters

## Depth — hops from the Create spine

reachable from `create:*`: **14036** items (avg **1.7** hops); unreachable: **3012**
  0:698  1:7176  2:3323  3:1719  4:790  5:244  6:53  7:20  8:6 …
