...
- Inventory sorting is provided by Inventory Essentials: a sort button/keybind in every container,
  shift/drag bulk moves, and nothing to configure. (Replaced Inventory Profiles Next in 0.7.1.)
