...
// `northstar:martian_steel_sheet` via `create:pressing`. The space suits and martian_steel LAMPS
// already build from that pressed PLATE — but the base martian_steel ARMOR set still uses the raw INGOT,
...
ServerEvents.recipes(event => {
  ...
  const P = 'northstar:martian_steel_sheet' // create:pressing of martian_steel (concrete, not the #c:plates/martian_steel tag)
