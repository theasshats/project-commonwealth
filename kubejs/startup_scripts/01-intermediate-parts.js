...
//
// Naming: pcmc:incomplete_<machine>. Keep one per sequenced chain.

StartupEvents.registry('item', event => {
  event.create('pcmc:incomplete_force_projector')
    .displayName('Incomplete Force Projector')
    .texture('minecraft:item/netherite_scrap')

  event.create('pcmc:incomplete_interdiction_matrix')
